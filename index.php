	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<img src="dist/img/solomon.png" alt="Bromen Logo" class="brand-image" style="width: 24px; margin-right: 4px;">
						<font color="white">
							<b>
								<?php echo $nama; ?>
							</b>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/bromen.jpg" alt="Bromen Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> BROMEN SKINCARE</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=data-kinerja" class="nav-link">
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'view-pegawai':
					...
					//Kinerja
				case 'data-kinerja':
					include "admin/kinerja/data_kinerja.php";
					break;
				case 'add-kinerja':
					include "admin/kinerja/add_kinerja.php";
					break;
				case 'edit-kinerja':
					include "admin/kinerja/edit_kinerja.php";
					break;
				case 'del-kinerja':
					include "admin/kinerja/del_kinerja.php";
					break;
				case 'view-kinerja':
					include "admin/kinerja/view_kinerja.php";
					break;
